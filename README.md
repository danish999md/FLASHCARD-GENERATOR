...
![Flashcard Generator](https://github.com/danish999md/FlashCard_Generator/blob/main/src/Assets/GIF.gif)
...
1. Clone the repository from GitHub:
    ```
     git clone https://github.com/danish999md/FLASHCARD-GENERATOR.git
    ```
